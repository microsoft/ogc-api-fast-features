...
from oaff.app.data.sources.postgresql.settings import ENV_VAR_PREFIX, name_to_suffix

OAFF_SCHEMA_NAME: Final = "oaff"
OAFF_METADATA: Final = MetaData(schema=OAFF_SCHEMA_NAME)
