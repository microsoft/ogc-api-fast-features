...
from feapi.app.data.sources.postgresql.stac_hybrid import settings
...
def upgrade():
    op.create_table(
        ...
        schema=settings.FEAPI_SCHEMA_NAME,
    )


def downgrade():
    op.drop_table("collections", schema=settings.FEAPI_SCHEMA_NAME)
