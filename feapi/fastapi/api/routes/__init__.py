...
from feapi.fastapi.api.routes.collections import (
    PATH as path_collections,
    ROUTER as router_collections,
)
from feapi.fastapi.api.routes.conformance import (
    PATH as path_conformance,
    ROUTER as router_conformance,
)
from feapi.fastapi.api.routes.control import (
    PATH as path_control,
    ROUTER as router_control,
)
from feapi.fastapi.api.routes.landing_page import (
    PATH as path_landing_page,
    ROUTER as router_landing_page,
)
from feapi.fastapi.api.settings import ROOT_PATH
